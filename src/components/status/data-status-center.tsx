    ...
    {health ? <>
      ...
      <Card className="settlement-operations">
        ...
        {operations?.available ? <>
          ...
          {operations.canRetry ? <footer><Button variant="secondary" onClick={retrySettlement} disabled={retrying}><RefreshCw /> {retrying ? "Checking official result…" : "Check my completed picks"}</Button><small>Available after your event starts; rate-limited to protect provider data. Results still come only from the official provider.</small></footer> : null}
