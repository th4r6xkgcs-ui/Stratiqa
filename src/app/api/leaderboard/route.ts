...
export async function GET(request: Request) {
  ...
  const response = await fetch(`${url}/rest/v1/rpc/get_competitive_leaderboard_v2`, {
    ...
    body: JSON.stringify({
      ...
      requested_region: params.get("region") || null, requested_locality: params.get("locality") || null,
      requested_season_start: seasonStart, result_limit: 50,
    }),
  });
