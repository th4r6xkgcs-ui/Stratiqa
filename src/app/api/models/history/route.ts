...
export async function GET() {
  ...
  const [snapshotsResponse, picksResponse, modelsResponse] = await Promise.all([
  ...
  return Response.json({ history, calibration: calibrationSummary(history), studio: buildImprovementStudio(models, history), available: true });
}
